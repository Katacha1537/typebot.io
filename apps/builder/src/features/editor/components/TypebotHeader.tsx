  ...
  return (
    <HStack {...props}>
      ...
      {currentUserMode === 'guest' && (
        <Button
          as={Link}
          href={`/ecombots/${typebot?.id}/duplicate`}
          leftIcon={<CopyIcon />}
...
const TypebotNav = ({
  ...
  return (
    <HStack {...stackProps}>
      ...
      <Button
        as={Link}
        href={`/ecombots/${typebotId}/settings`}
      ...
      {isResultsDisplayed && (
        <Button
          as={Link}
          href={`/ecombots/${typebotId}/results`}
