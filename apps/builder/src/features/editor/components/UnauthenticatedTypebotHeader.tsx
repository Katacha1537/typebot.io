  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button
          as={Link}
          href={`/ecombots/${typebot?.id}/theme`}
        ...
        <Button
          as={Link}
          href={`/ecombots/${typebot?.id}/settings`}
              ...
              href={
                !user
                  ? {
                      pathname: `/register`,
                      query: {
                        redirectPath: `/ecombots/${typebot.id}/duplicate`,
                      },
                    }
                  : `/ecombots/${typebot.id}/duplicate`
              }
              leftIcon={<CopyIcon />}
